...
However, this alone is not enough to achieve XSS. Therefore, we should focus on the fact that notes are stored in the file system.

In Golang, `os.Open()` and `os.OpenFile()` call internal func `openFileNolog()`
